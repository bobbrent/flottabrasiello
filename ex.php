...
$macchine = tellMeMacchineSede($sedes);
...
$spreadsheet->setActiveSheetIndex(1)->setCellValue('D1', 'DATA E ORA ARRIVO')->getStyle('D1')->getFont()->setBold(true);
$spreadsheet->setActiveSheetIndex(1)->setCellValue('E1', 'DATA E ORA USCITA')->getStyle('E1')->getFont()->setBold(true);
$spreadsheet->setActiveSheetIndex(1)->setCellValue('F1', 'DEPOSITO')->getStyle('F1')->getFont()->setBold(true);
$spreadsheet->setActiveSheetIndex(1)->setCellValue('G1', 'NOTE')->getStyle('G1')->getFont()->setBold(true);
$spreadsheet->setActiveSheetIndex(1)->setCellValue('H1', 'SMONTAGGIO TARGHE')->getStyle('H1')->getFont()->setBold(true);
$spreadsheet->setActiveSheetIndex(1)->setCellValue('I1', 'LAVAGGIO')->getStyle('I1')->getFont()->setBold(true);
$spreadsheet->setActiveSheetIndex(1)->setCellValue('J1', 'LAVAGGIO ESTERNO/INTERNO')->getStyle('J1')->getFont()->setBold(true);
$spreadsheet->setActiveSheetIndex(1)->setCellValue('K1', 'FOTO')->getStyle('K1')->getFont()->setBold(true);
...
foreach($macchine as $v){
  ...
  // 
  // mod: togliere ora, telaio prima altrimenti targa
  //
  ...
  $spreadsheet->setActiveSheetIndex(1)->setCellValue("D$contariga", formattaDataALD($v[9]));
  if($v[19]){
    $spreadsheet->setActiveSheetIndex(1)->setCellValue("E$contariga", formattaDataALD($v[19]));
  }
  $spreadsheet->setActiveSheetIndex(1)->setCellValue("F$contariga", tellMePiazzale($v[1]));
  $spreadsheet->setActiveSheetIndex(1)->setCellValue("G$contariga", $v[21]);
  $lav = tellMeLavorazioniMacchina($v[0]);
  if($lav != 'no'){
      if($lav[0][2] != 0){
        $spreadsheet->setActiveSheetIndex(1)->setCellValue("H$contariga", $lav[0][2]);
      }
      if($lav[0][3] != 0){
        $spreadsheet->setActiveSheetIndex(1)->setCellValue("I$contariga", $lav[0][3]);
      }
      if($lav[0][4] != 0){
        $spreadsheet->setActiveSheetIndex(1)->setCellValue("J$contariga", $lav[0][4]);
      }
      if($lav[0][5] != 0){
        $spreadsheet->setActiveSheetIndex(1)->setCellValue("K$contariga", $lav[0][5]);
      }
  }
  $contariga++;
}
...
$spreadsheet->getActiveSheet()->getStyle('A1:K1')->getFont()->getColor()->setARGB(\PhpOffice\PhpSpreadsheet\Style\Color::COLOR_RED);
//NOME FOGLIO
...
$nome_file = "INVENTARIO STOCK - $datanome";
